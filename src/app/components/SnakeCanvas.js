...
export default function SnakeCanvas() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("canvas", { ref: canvasRef, width: COLS * CELL, height: ROWS * CELL }), _jsx("div", { className: "mt-3 text-center text-lg font-mono text-gray-100", children: _jsxs("span", { className: bump ? "score-bump" : "", children: ["Score: ", score] }) })] }));
}
