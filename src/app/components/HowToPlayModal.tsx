    ...
    >
      ...
      >
        ...
        <div className="space-y-4 p-4 text-sm text-zinc-300">
          <p>Guide the snake to eat food and grow. Don&apos;t hit walls, obstacles, or yourself!</p>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li><span className="text-amber-400">⭐ Golden</span> — +5 points</li>
              <li><span className="text-cyan-400">❄️ Freeze</span> — Pause timer briefly</li>
              <li><span className="text-purple-400">👻 Ghost</span> — Pass through yourself once</li>
              <li><span className="text-orange-400">🔥 Multiplier</span> — +3 points</li>
            </ul>
          </div>
          <div>
            <h3 className="mb-2 font-semibold text-white">Difficulty</h3>
            <p>Choose Relaxed for wrap-around edges, or Classic/Expert for obstacles. Blitz starts fast!</p>
          </div>
        </div>
      </div>
    </div>
